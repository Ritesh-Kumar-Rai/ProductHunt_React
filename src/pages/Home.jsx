  ...
  return (
    <>
      <div className='w-full h-72 rounded-lg shadow-lg overflow-hidden group'>
        <img src="https://plus.unsplash.com/premium_photo-1681398745480-151fc6addaaf?q=80&w=1160&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="e-commerce banner" loading='lazy' className='h-full w-full object-cover transition-transform duration-200 transform scale-100 group-hover:scale-110 bg-blue-500' />
      </div>
